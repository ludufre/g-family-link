...
var CONFIG_DIR = join(homedir(), ".config", "g-family-link");
var COOKIES_FILE = join(CONFIG_DIR, "cookies.json");
function ensureDir() {
...
function saveCookies(cookies) {
  ensureDir();
  writeFileSync(COOKIES_FILE, JSON.stringify(cookies, null, 2), { mode: 384 });
}
